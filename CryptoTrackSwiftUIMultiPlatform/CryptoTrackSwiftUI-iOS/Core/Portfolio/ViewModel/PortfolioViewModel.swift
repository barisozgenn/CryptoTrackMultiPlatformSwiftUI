...
class PortfolioViewModel:  ObservableObject {
    ...
    private func calculateHoldingTotal(pEntity : PortfolioEntity, pEntities : [PortfolioEntity], currency : CryptoCurrency) -> CryptoCurrency {
        ...
        return currency.updateHolding(unitPrice: unitPrice,unitLowest: 0.0, unitHighest: 0.0, amount: totalAmount, transactionType: pEntity.transactionType ?? "b", dateCreated: pEntity.dateCreated ?? Date())
